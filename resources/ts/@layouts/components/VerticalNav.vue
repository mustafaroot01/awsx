  ...
  >
    ...
    <div class="nav-header">
      <slot name="nav-header">
        ...
        >
          <img v-if="branding.settings.value.app_logo_url" :src="branding.settings.value.app_logo_url" style="max-height: 32px; width: auto;">
          ...
          <Transition name="vertical-nav-app-title">
            ...
            >
              {{ branding.settings.value.app_name }}
            </h1>
          </Transition>
        </RouterLink>
